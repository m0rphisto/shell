/**
 * ---------------------------------------------------------------------
 * Id: privtest.c v0.2 2024-02-02 23:29:40 +0100 .m0rph $
 * ---------------------------------------------------------------------
 *
 * Description:
 *  Little tool, utilized by the shell script privtest.
 *
...
int main()
{
   ...
   {
      // First test, if we can set privileges.
      fprintf(stderr, "\x1b[1;31mFailed to set UID/GID 0\x1b[0m\n");
      return 1;
   } 
